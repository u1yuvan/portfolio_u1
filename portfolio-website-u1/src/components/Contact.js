    ...
    <div id='contact' className=' w-full h-screen  flex justify-center items-center p-4'>
      <form action='' className='flex flex-col max-w-[600px] w-full'>
          <div className='pb-8'>
            ...
            <p className=' text-gray-300 py-4'>//Submit the form below or shoot me an email - yuvanraj700@gmail.com</p>
          </div>
          <input className=' bg-[#ccd6f6] ' type='text' placeholder='Name' name='name'/>
          <input className=" my-4 p-2 bg-[#ccd6f6]" type='email' placeholder='Email' name='email'/>
          <textarea name='message' rows="10" className=' bg-[#ccd6f6] ' ></textarea>
