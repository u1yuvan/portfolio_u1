        ...
        <ul>
          <li className='w-[160px] h-[70px] flex justify-between items-center mb-[-20px]'>
            <a href="https://www.linkedin.com/in/yuvan-raj-374b26244/" target='blank' className=' flex justify-start items-center w-[138px] 
              ml-[-85px] pl-2 hover:ml-[-10px] bg-[#0077b5]   text-white duration-300 shadow-md shadow-black'>
          ...
          <li className=' w-[160px] h-[70px] flex justify-between items-center'>
            <a href="https://github.com/u1yuvan" target='blank' className='  flex justify-start items-center w-[125px] ml-[-71px] pl-2  hover:ml-[-10px] bg-[#2b3137]   text-white duration-300 shadow-md shadow-black'>
          ...
          <li className=' w-[160px] h-[60px] flex justify-between items-center  '>
            <a   target='blank' className='  flex justify-start items-center w-[138px] ml-[-85px] mt-[-65px] pl-2 h-[45px] hover:ml-[-10px] bg-[#2b3137] text-white duration-300 shadow-md shadow-black'>
